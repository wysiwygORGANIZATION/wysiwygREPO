...
alter table `cart`   add index fk_cart_cart_item (`oid`), add constraint fk_cart_cart_item foreign key (`oid`) references `cart_item` (`oid`);
...
alter table `cart_item`   add index fk_cart_item_music (`music_oid`), add constraint fk_cart_item_music foreign key (`music_oid`) references `music` (`oid`);
