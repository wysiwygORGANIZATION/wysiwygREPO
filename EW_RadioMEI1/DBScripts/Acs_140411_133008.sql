...
create table `music_playlist` (
  ...
  primary key (`music_oid`, `playlist_oid`)
);
alter table `music_playlist`   add index fk_music_playlist_music (`music_oid`), add constraint fk_music_playlist_music foreign key (`music_oid`) references `music` (`oid`);
alter table `music_playlist`   add index fk_music_playlist_playlist (`playlist_oid`), add constraint fk_music_playlist_playlist foreign key (`playlist_oid`) references `playlist` (`oid`);
