...
alter table `play_list_item`   add index fk_play_list_item_music (`cartitem_oid`), add constraint fk_play_list_item_music foreign key (`cartitem_oid`) references `music` (`oid`);
