...
-- Play List Item_Cart Item [rel7]
alter table `music`  add column  `oid`  integer;
alter table `music`   add index fk_music_play_list_item (`oid`), add constraint fk_music_play_list_item foreign key (`oid`) references `play_list_item` (`oid`);
