...
alter table `cartitem`   add index fk_cartitem_music_2 (`music_oid`), add constraint fk_cartitem_music_2 foreign key (`music_oid`) references `music` (`oid`);
...
alter table `cartitem`   add index fk_cartitem_music (`oid`), add constraint fk_cartitem_music foreign key (`oid`) references `music` (`oid`);
